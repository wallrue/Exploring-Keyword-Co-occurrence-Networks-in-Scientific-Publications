...
Based on the analysis of the provided dataset, the resulting network contains **248 unique nodes** (keywords) and **2,141 edges** (unique connections).

<table style="width:100%">
  <tr>
    <th style="text-align:left">Table 1: Top 10 by Degree</th>
    <th style="text-align:left">Table 2: Top 10 by Strength</th>
  </tr>
  <tr>
